...
const Login = () => {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      // 使用安全的登入 API（HttpOnly Cookie + CSRF Token）
    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <header className="w-full px-8 py-4 flex items-center justify-between border-b border-gray-200">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xl text-gray-600">安全登入</span>
          {/* 安全標誌 */}
          <div className="ml-2 flex items-center gap-1 bg-green-100 text-green-700 px-2 py-1 rounded-full text-xs">
      ...
      <div className="flex-1 flex relative bg-gradient-to-br from-blue-500 via-blue-600 to-blue-700 overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-30">
          ...
          <div
            className="absolute bottom-0 right-0 w-96 h-96 bg-blue-300 rounded-full blur-3xl animate-glow"
        ...
        <div className="flex-1 relative z-10">
          <div className="h-full flex flex-col items-center justify-center p-12 text-white">
            ...
            {/* Date Range */}
            <div className="text-2xl font-semibold mb-8 drop-shadow-md">
              12/26 - 1/11
            </div>

            {/* Blue Coupon */}
            <div
              className="absolute bottom-12 right-12 w-32 h-32 bg-gradient-to-br from-cyan-400 to-blue-500 rounded-lg transform rotate-12 shadow-2xl flex items-center justify-center animate-float"
            ...
            <div className="w-full max-w-sm bg-white rounded-xl shadow-2xl p-8">
              ...
              <div className="mb-6 p-3 bg-green-50 border border-green-200 rounded-lg">
                <div className="flex items-center gap-2 text-green-700 text-sm">
                  ...
                  <span>使用 HttpOnly Cookie + CSRF Token 保護</span>
                </div>
              </div>
